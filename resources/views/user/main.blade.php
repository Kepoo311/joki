            ...
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    <a href="#riview"
                        ...
                        @if ($riviews->count() > 0)
                            <span
                                class="inline-flex items-center justify-center w-3 h-3 p-3 ms-3 text-sm font-medium text-blue-800 bg-blue-100 rounded-full dark:bg-blue-900 dark:text-blue-300">{{ $riviews->count() }}</span>
                        @endif
                    </a>
                </li>
            </ul>
