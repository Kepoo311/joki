...
<div id="toast-success" class="fixed top-5 left-5 z-[999] flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
            ...
            <div class="grid justify-items-center grid-cols-1 lg:grid-cols-2 xl:grid-cols-3">
                ...
                <section class="m-3 p-2 h-fit w-80 bg-gray-800 shadow-xl rounded-md">
                    ...
                    <div class="flex flex-col border-b-2 py-5">
                        <img class="w-20 h-20 rounded-full self-center" src="{{ asset('img/ComPP/' . auth()->user()->profil) }}"
                            alt="user photo">
                ...
                <div class="relative p-4 w-full max-w-md max-h-full">
                    ...
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <div class="p-4 md:p-5">
                            <form class="space-y-4" action="{{ route('account_changes') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div>
                                    <label for="profile"
                                        ...
                                        profile</label>
                                        <input class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" id="profile" name="profil" type="file">
                                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-300" id="file_input_help">SVG, PNG, JPG , WEBP, AVIF or GIF (MAX. 1mb).</p>
                                        @error('profil')
